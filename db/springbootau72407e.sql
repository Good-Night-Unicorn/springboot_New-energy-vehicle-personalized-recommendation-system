...
CREATE TABLE `cart`  (
  ...
  `userid` bigint(0) NOT NULL COMMENT '用户id',
  `goodid` bigint(0) NOT NULL COMMENT '汽车id',
...
CREATE TABLE `shangjia`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `shangjiahao`(`shangjiahao`) USING BTREE
...
CREATE TABLE `shangpinzhonglei`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `shangpinzhonglei`(`shangpinzhonglei`) USING BTREE
...
CREATE TABLE `storeup`  (
  ...
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `userid` bigint(0) NOT NULL COMMENT '用户id',
  `refid` bigint(0) NULL DEFAULT NULL COMMENT '汽车id',
...
INSERT INTO `token` VALUES (2, 1, 'admin', 'users', '管理员', '0l0xq8e5ijg6usgpm95ayvz5v206awn3', '2024-03-25 13:53:28', '2024-03-25 19:48:03');
